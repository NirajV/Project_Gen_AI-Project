...
def execute_sql_script(script_path):
    ...
    # We connect to the default database (likely EDW_STAGE_DB) defined in db_connection
    ...
    try:
        ...
        connection.commit()
        print("Success: Data loaded into Product_Revenue_Analysis table.")
...
if __name__ == "__main__":
    ...
    sql_file = os.path.join(current_dir, "DDL_N_DML_Scripts", "Load_Product_Revenue.sql")
